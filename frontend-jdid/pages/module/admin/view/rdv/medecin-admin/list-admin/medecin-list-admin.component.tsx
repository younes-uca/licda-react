...
import Edit from '/pages/module/admin/view/rdv/medecin-admin/edit-admin/medecin-edit-admin.component';
import Create from '/pages/module/admin/view/rdv/medecin-admin/create-admin/medecin-create-admin.component';
import View from '/pages/module/admin/view/rdv/medecin-admin/view-admin/medecin-view-admin.component';
