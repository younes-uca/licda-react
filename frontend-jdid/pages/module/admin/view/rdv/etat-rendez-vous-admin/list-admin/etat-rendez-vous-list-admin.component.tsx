...
import Edit from '/pages/module/admin/view/rdv/etat-rendez-vous-admin/edit-admin/etat-rendez-vous-edit-admin.component';
import Create from '/pages/module/admin/view/rdv/etat-rendez-vous-admin/create-admin/etat-rendez-vous-create-admin.component';
import View from '/pages/module/admin/view/rdv/etat-rendez-vous-admin/view-admin/etat-rendez-vous-view-admin.component';
...
const List = () => {
   ...
   const rightToolbarTemplate = () => {
    ...
    const header = (
        ...
        <h5 className="m-0">Manage EtatRendezVouss</h5>
