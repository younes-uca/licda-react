...
import Edit from '/pages/module/admin/view/rdv/etatDose-admin/edit-admin/etatDose-edit-admin.component';
import Create from '/pages/module/admin/view/rdv/etatDose-admin/create-admin/etatDose-create-admin.component';
import View from '/pages/module/admin/view/rdv/etatDose-admin/view-admin/etatDose-view-admin.component';
...
const List = () => {
   ...
   const rightToolbarTemplate = () => {
    ...
    const header = (
        ...
        <h5 className="m-0">Manage EtatDoses</h5>
