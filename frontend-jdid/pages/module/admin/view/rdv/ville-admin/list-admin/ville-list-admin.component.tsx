...
import Edit from '/pages/module/admin/view/rdv/ville-admin/edit-admin/ville-edit-admin.component';
import Create from '/pages/module/admin/view/rdv/ville-admin/create-admin/ville-create-admin.component';
import View from '/pages/module/admin/view/rdv/ville-admin/view-admin/ville-view-admin.component';
