...
import Edit from '/pages/module/admin/view/rdv/quartier-admin/edit-admin/quartier-edit-admin.component';
import Create from '/pages/module/admin/view/rdv/quartier-admin/create-admin/quartier-create-admin.component';
import View from '/pages/module/admin/view/rdv/quartier-admin/view-admin/quartier-view-admin.component';
