...
import Edit from '/pages/module/admin/view/rdv/categorieRdv-admin/edit-admin/categorieRdv-edit-admin.component';
import Create from '/pages/module/admin/view/rdv/categorieRdv-admin/create-admin/categorieRdv-create-admin.component';
import View from '/pages/module/admin/view/rdv/categorieRdv-admin/view-admin/categorieRdv-view-admin.component';
...
const List = () => {
   ...
   const rightToolbarTemplate = () => {
    ...
    const header = (
        ...
        <h5 className="m-0">Manage CategorieRdvs</h5>
