...
import Edit from '/pages/module/admin/view/rdv/effetIndesirable-admin/edit-admin/effet-indesirable-edit-admin.component';
import Create from '/pages/module/admin/view/rdv/effetIndesirable-admin/create-admin/effet-indesirable-create-admin.component';
import View from '/pages/module/admin/view/rdv/effetIndesirable-admin/view-admin/effet-indesirable-view-admin.component';
