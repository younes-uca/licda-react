...
import Edit from '/pages/module/admin/view/rdv/gender-admin/edit-admin/gender-edit-admin.component';
import Create from '/pages/module/admin/view/rdv/gender-admin/create-admin/gender-create-admin.component';
import View from '/pages/module/admin/view/rdv/gender-admin/view-admin/gender-view-admin.component';
